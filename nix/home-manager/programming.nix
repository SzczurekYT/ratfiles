    ...
    profiles.default = {
      ...
      userSettings = {
        ...
        "explorer.fileNesting.patterns" = {
          "pubspec.yaml" =
            ".flutter-plugins, .packages, .dart_tool, .flutter-plugins-dependencies, .metadata, .packages, pubspec.lock, build.yaml, analysis_options.yaml, all_lint_rules.yaml";
          ".gitignore" = ".gitattributes, .gitmodules, .gitmessage, .mailmap, .git-blame*";
          "readme.*" =
            "authors, backers.md, changelog*, citation*, code_of_conduct.md, codeowners, contributing.md, contributors, copying, credits, governance.md, history.md, license*, maintainers, readme*, security.md, sponsors.md";
